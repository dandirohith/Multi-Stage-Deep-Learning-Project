...
Original file is located at
    https://colab.research.google.com/drive/1aLqqk3URzHaYSv_ghVEJyB-NFIBGm9wF
"""
...
def evaluate_model(model, sources, raw_dataset):
  ...
  for i, source in enumerate(sources):
    ...
    if i < 10:
      ...
      # print(raw_target.split())
      # print(translation.split())
    actual.append([raw_target.split()])
    predicted.append(translation.split())
  # actual = [[' '.join(sentence)] for sentence in actual]
  # predicted = [' '.join(sentence) for sentence in predicted]
  print(actual)
  print(predicted)
